...
class List
{
	...
	public:
			...
			X popBack()
			{
				...
				{
					Node<X> *l_LastButNode = getLast_1();
					l_Value = this->m_Tail->m_Value;
					this->m_Tail = l_LastButNode;
					delete l_LastButNode->m_Next;
					l_LastButNode->m_Next = NULL;
					--this->m_Size;
				}
				return l_Value;
			}
